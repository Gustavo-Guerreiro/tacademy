...
<main>
  ...
  <div id="alerta">
    <%
      ...
      if (problema != null) {
    %>
      <div class="alert alert-danger">Um usuário com esse <% out.print(problema); %> já foi cadastrado</div>
    <%
      }
    %>
    </div>
    <form action="criarConta.jsp" method="post" onsubmit="return validaCadastro()">
      <input type="text" required name="nome" id="nome" placeholder="Nome" class="form-control" maxlength="50">
      <input type="email" required name="email" id="email" placeholder="E-mail" class="form-control" maxlength="50">
      <input type="email" required name="confEmail" id="confEmail" placeholder="Confirmar E-mail" class="form-control" maxlength="50">
      <input type="password" required name="senha" id="senha" placeholder="Senha" class="form-control" maxlength="50">

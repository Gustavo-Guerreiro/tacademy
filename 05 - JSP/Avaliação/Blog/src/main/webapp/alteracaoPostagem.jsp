...
<main>
  ...
  <form action="alterarPostagem.jsp" method="post">
    <input type="text" readonly required placeholder="Nome" id="nome" name="nome" class="form-control" maxlength="50" value="<% out.print(rs.getString(2)); %>" >
    ...
    <input type="hidden" value="<% out.print(rs.getInt(1)); %>" name="cd_postagem" >

...
<main>
  ...
  if (session.getAttribute("tipo").toString().equals("A")) {
    ...
    String sql =
            "SELECT cd_usuario, nm_usuario, fg_banido, ds_email, vl_senha FROM usuario WHERE fg_tipo <> 'A'";
  ...
  <div class="comentarios">
    ...
    <div class="card">
      <div class="card-body">
        <p class="card-text">Nome: <% out.print(rs.getString(2)); %></p>
        <p class="card-text">E-mail:  <% out.print(rs.getString(4)); %> </p>
        ...
        %>
          <br>
          <br>
          <a href="desbanirUsuario.jsp?cd_usuario=<%out.print(rs.getString(1));%>" class="btn btn-outline-success">Desbanir</a>
        <%
            break;
          case "N":
              out.print("Não Banido");
        %>
          <br>
          <br>
          <a href="banirUsuario.jsp?cd_usuario=<%out.print(rs.getString(1));%>" class="btn btn-outline-danger">Banir</a>
        <%
          }
        %> </p>
      </div>

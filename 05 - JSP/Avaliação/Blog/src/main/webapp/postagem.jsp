    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="postagem.jsp">Cadastrar Postagem</a>
                </li>
...
<main>
  ...
  <form action="cadastrarPostagem.jsp" method="post">
      ...
      <input type="text" required readonly placeholder="Nome" id="nome" name="nome" class="form-control" maxlength="50" value="<%out.print(session.getAttribute("nome"));%>">
      <%} else {%>
    ...
    %>
      <input type="hidden" name="cdUsuario" value="<%session.getAttribute("idUsuario");%>">
      <%
          }
      %>

...
<body>
	<%
		...
		int cd_usuario = Integer.parseInt( session.getAttribute("cdUsuario").toString() );
		
		// Efetuar conexão
		Conexao c = new Conexao();
		
		// SQL
		String sql = "INSERT INTO comentario (nm_cliente, ds_mensagem, cd_postagem, cd_usuario ) VALUES (?,?,?,?)";
